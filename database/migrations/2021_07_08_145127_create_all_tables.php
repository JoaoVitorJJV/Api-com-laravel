...
class CreateAllTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('userappoiments', function (Blueprint $table) {
            $table->id();
            $table->integer('id_user');
            $table->integer('id_barber');
        ...
        Schema::create('barberavaliabillity', function (Blueprint $table) {
            $table->id();
            $table->integer('id_barber');
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('userappoiments');
        ...
        Schema::dropIfExists('barberavaliabillity');
    }
}
